...
public class main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("12:Xuat thong tin danh sach theo gia tang dan.");
            ...
            if (a < 1 || a > 13) {
                ...
                switch (a) {
                    ...
                    case 12: {
                        ...
                        switch (x) {
                            case 1: {
                                dsxecontay.sapXepTheoPtTangDan();
                                dsxecontay.xuatthongtin();
                                break;
                            }
                            case 2: {
                                dsxeso.sapXepTheoPtTangDan();
                                dsxeso.xuatthongtin();
                                break;
                            }
                            case 3: {
                                dsxetayga.sapXepTheoPtTangDan();
                                dsxetayga.xuatthongtin();
                                break;
                            }
                        }
